...
export default function Navbar() {
  ...
  return (
    <div className="flex items-center bg-(--secondary-color) w-full pt-2 pb-2 pr-8 pl-8">
        ...
        <Link className="relative text-(--primary-color) hover:text-(--tertiary-color) border-(--primary-color) hover:border-(--tertiary-color) border-2 border-solid  rounded-lg p-1 ml-auto" to="/buy">
          Shopping Cart
          { totalProducts > 0 
